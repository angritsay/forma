...
--   9. Триггеры о платежах и пруфах кладут id платежа и пруфа — для ссылки из телеграма прямо
...
--
-- Тексты 0043 (платежи) и 0040 (пруфы) плюс id: `paymentId`, `proofId` и `marathonId`. По ним
-- `telegram-notify` собирает ссылку прямо на платёж или на сам пруф.
-- -----------------------------------------------------------------------------
