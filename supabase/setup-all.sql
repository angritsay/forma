...
insert into public.exercises (
  ...
  ('knee_circles', 'Круги коленями', 'Knee circles', 'Круги коленями', 'Круги коленями — классика суставной гимнастики перед приседаниями и выпадами. Стопы вместе, ладони на коленях, колени рисуют небольшие круги; сустав получает движение и синовиальную жидкость до того, как на него ляжет нагрузка. Круги маленькие и мягкие — колено не любит больших кругов под весом.', 'quads', '{"quads","calves"}', 'mobility', '{"none"}', 1, 'seconds', null, null, null, '{"warmup","mobility","lower"}', false, 59),
