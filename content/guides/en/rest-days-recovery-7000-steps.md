...
faq:
  ...
  - q: 'What if muscle soreness is severe and will not go away?'
    a: 'An easy walk and full-range movement clear soreness faster than lying still. If the pain is sharp, one-sided, in a joint, or lasts more than four or five days, see a doctor.'
relatedExercises:
  - cat_cow
...
Every workout is a stress. You load muscles, tendons and the nervous system, some fibres take micro-damage, and the energy stores in the muscle drop. What follows is not just repair: the body rebuilds with a margin so the same load feels easier next time. That margin is your progress, and it only appears under two conditions: the stimulus was big enough and the pause after it was long enough for the rebuild to finish.

Too short a pause and you show up under-recovered: technique is worse, reps are fewer, effort is higher. Too long and the stimulus fades, so every session becomes a "first" session again. Rest days set the rhythm of this process, and steps on rest days are a way to keep moving without interrupting the repair. Easy walking improves blood flow, loosens stiff muscles and adds no new damage, which is why coaches call it active recovery.

## How many rest days a week

The ACSM position stand on progression in resistance training recommends 48 to 72 hours between sessions for the same muscle groups in novices. Home workouts almost always load the whole body, so two intense sessions need at least one day between them. Three or four workouts a week on alternate days fits that window and still leaves room for walking.

The WHO recommends 150 to 300 minutes of moderate activity a week for adults, or 75 to 150 minutes of vigorous activity, plus muscle-strengthening work on two days. Note that most of that volume is moderate activity, which is exactly what walking is, not all-out training. How to distribute sessions across the week is covered in the [training frequency guide](guide:training-frequency).

### Signs you are not recovering enough

- Your RPE sits at 9 or 10 for the same volume you handled a week ago.
- You stop completing the plan: completion drops below 80 percent when it used to be full.
- Your resting heart rate in the morning is higher than usual, sleep is worse, you are irritable.
- Muscles ache all week instead of one or two days, or joints start to ache.

Forma watches the first two on its own. If your last session was less than 24 hours ago, was rated 9 or higher, was completed below 80 percent, or you flagged pain, the app recommends the "easier" option before the next workout and tells you why. If fatigue lasts for weeks, a joint hurts or you have a chronic condition, rest is not a substitute for seeing a doctor.
...
**Mobility circuit, 10 minutes, two rounds, no timer and no rest between exercises:**

1. [Cat-cow](exercise:cat_cow), 10 reps, slow, with the breath.
2. [World's greatest stretch](exercise:worlds_greatest_stretch), 5 reps per side.
3. [Glute bridge](exercise:glute_bridge), 15 reps with a pause at the top.
4. [Dead bug](exercise:dead_bug), 10 reps per side.
5. [Bird dog](exercise:bird_dog), 10 reps per side.
6. [Hip flexor stretch](exercise:hip_flexor_stretch), 40 seconds per side.
7. [Hamstring stretch](exercise:hamstring_stretch), 40 seconds per side.
8. [Child's pose](exercise:child_pose), 60 seconds, second round only.

No jumps, no push-ups to failure, effort no higher than 3 or 4 out of 10. If something hurts sharply, skip the exercise rather than push through it.

### Sleep, food, water

The American Academy of Sleep Medicine recommends that adults sleep at least seven hours a night; on a rest day that matters more than any circuit. Eat normally and do not "pay for" the day off by cutting calories: recovery needs protein and energy. Drink to thirst, a little more if the day is hot or the walk was long.
