...
export const EXERCISES_B: ExerciseInput[] = [
  ...
  },
  {
    ...
    met: 2.5,
    loadable: false,
    video: { ru: 'storage:videos/shared/arm_circles.ru.mp4' },
    scaling: {},
  ...
  },
  {
    ...
    met: 2.8,
    loadable: false,
    video: { ru: 'storage:videos/shared/leg_swing.ru.mp4' },
    scaling: {},
  ...
  },
  {
    ...
    met: 2.3,
    loadable: false,
    video: { ru: 'storage:videos/shared/cat_cow.ru.mp4' },
    scaling: {},
  ...
  },
  {
    ...
    met: 2.3,
    loadable: false,
    video: { ru: 'storage:videos/shared/hip_flexor_stretch.ru.mp4' },
    scaling: {},
  ...
  },
  {
    ...
    met: 2.3,
    loadable: false,
    video: { ru: 'storage:videos/shared/hamstring_stretch.ru.mp4' },
    scaling: {},
    tags: ['cooldown', 'mobility', 'lower', 'unilateral'],
  },
  {
    ...
    met: 2.3,
    loadable: false,
    video: { ru: 'storage:videos/shared/child_pose.ru.mp4' },
    scaling: {},
  ...
  /* --- Joint mobility: the coach's warm-up, top to bottom ---------------------------------- */
  {
    ...
    met: 2.0,
    loadable: false,
    video: { ru: 'storage:videos/shared/neck_circles.ru.mp4' },
    scaling: {},
    tags: ['warmup', 'mobility', 'upper'],
  },
  {
    ...
    met: 2.3,
    loadable: false,
    video: { ru: 'storage:videos/shared/elbow_wrist_circles.ru.mp4' },
    scaling: {},
    tags: ['warmup', 'mobility', 'upper'],
  },
  {
    ...
    met: 2.5,
    loadable: false,
    video: { ru: 'storage:videos/shared/side_bend.ru.mp4' },
    scaling: {},
  ...
  },
  {
    ...
    met: 2.3,
    loadable: false,
    video: { ru: 'storage:videos/shared/hip_circles.ru.mp4' },
    scaling: {},
    tags: ['warmup', 'mobility', 'lower'],
  },
  {
    ...
    met: 2.3,
    loadable: false,
    video: { ru: 'storage:videos/shared/knee_circles.ru.mp4' },
    scaling: {},
    tags: ['warmup', 'mobility', 'lower'],
  },
  {
    ...
    met: 2.0,
    loadable: false,
    video: { ru: 'storage:videos/shared/ankle_circles.ru.mp4' },
    scaling: {},
    tags: ['warmup', 'mobility', 'lower'],
  },
  {
    ...
    met: 2.3,
    loadable: false,
    video: { ru: 'storage:videos/shared/quad_stretch.ru.mp4' },
    scaling: {},
