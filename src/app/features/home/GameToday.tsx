/**
 * The club, on the home screen, as one row.
 *
 * Home used to never mention the club at all: it was reachable only from its own tab, which meant
 ...
 * not seeing it.
 *
 * The ring counts the days of the club, not any kind of score. Points belong to the club itself,
 * where they are the whole point; the honest figure here is how far in this is.
 *
 * It wears the club's colour and nothing else on Home does, because in this product colour says
...
export interface GameTodayProps {
  /** The club I am in, or null when I am not in one. */
  marathon: MyMarathon | null;
  /**
   * Whether the answer to "am I in the club" has arrived yet. Until it has there is nothing honest
   ...
   * blinks from «Клуб собирается без тебя» to today's task a moment later.
   */
  settled: boolean;
