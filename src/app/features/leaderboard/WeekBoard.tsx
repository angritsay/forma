 ...
 * pinned under it.
 *
 * The reports tab is where somebody asks how the week went, and "who is winning it" is part of that
...
export function WeekBoard({ limit = 5, onOpenFull }: WeekBoardProps) {
  ...
  return (
    <div className="flex flex-col">
      ...
      <Button variant="ghost" size="sm" className="mt-2 self-start" onClick={onOpenFull}>
