 ...
 *
 * Drawn the way the challenge's `BoardRow` draws its rows, because a product with two boards that
 * look different has two races. The leader's circle is filled — white here, not the challenge's
