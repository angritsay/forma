...
export const app = {
  ...
  sharePreviewAlt: 'A story with the workout results',
  shareRendering: 'Drawing your story…',
  shareAnother: 'Another design',
  shareInstagram: 'Instagram Stories',
  shareTelegramStory: 'Telegram Stories',
  shareTelegramChat: 'Telegram chat',
  shareSave: 'Save image',
  shareMore: 'More…',
  // The one line under the targets when Instagram can only be reached through the gallery.
  shareInstagramHint: 'The image is saved to your phone — open a story in Instagram and pick it.',
  ...
  personTitle: 'Person',
  personNoName: 'No name',
  personNeverSignedIn: 'Has not signed in yet',
  personSince: 'Joined {date}',
  personOnboarded: 'Onboarded',
  personNotOnboarded: 'Not onboarded',
  personLevel: 'Level {n}',
  personTelegram: 'Telegram linked',
  personNoTelegram: 'No Telegram',
  personSubUntil: 'Subscribed until {date}',
  personNoSub: 'No subscription',
  personGiveCourse: 'Give a course',
  personGiveSub: 'Give a subscription',
  personGiveWorkout: 'Give a workout',
  personCloseAccess: 'Close access',
  personRemoveClub: 'Remove from the club',
  personAccess: 'Access',
  personNoPurchases: 'No courses',
  personSubscription: 'Subscription',
  personClub: 'Club',
  personClubAccess: 'Has club access',
  personClubNoAccess: 'No club access',
  personNotInClub: 'Has not joined the club',
  personSolo: 'Solo',
  personDuo: 'Duo',
  personPartner: 'paired with {name}',
  personPartnerLead: 'paired with',
  personNoPartner: 'no pair',
  personRemoved: 'removed',
  personProofs: 'Proofs',
  personNoProofs: 'Nothing sent yet',
  personProofDay: 'day {n}',
  personProofCounted: 'Counted',
  personProofAccepted: 'Accepted',
  personProofWaiting: 'Awaiting review',
  personProofRejected: 'Rejected',
  personAssigned: 'Workouts from the coach',
  ...
  personActDays: 'days',
  personActPoints: 'points',
  personActLast: 'Last one — {date}',
  personActNever: 'No workouts yet',
  personSessionOpen: 'not finished',
  personSessionPoints: '{n} pts',
  personSupport: 'Support',
  personNoSupport: 'Never wrote in',
  personSupportApp: 'From the app',
  personSupportTelegram: 'From Telegram',
  personSupportLimited: 'turned away: rate limit',
  personSupportNote: 'The text itself is in the «Support» topic; here only when and where from.',
  personPayments: 'Payments',
  personNoPayments: 'No payments',
  personPayCourse: 'Course',
  personPayMonthly: 'Monthly plan',
  personPayAnnual: 'Annual plan',
  personPaySession: 'Coach session',
  personPayApplied: 'applied',
  personPayClaimed: 'claimed {date}',
  personPayPending: 'not applied',
  personPayVia: 'paid from {email}',
  personPayEmails: 'Also pays from: {emails}',
  personLoadError: "Couldn't load this person",
  personBadEmail: 'That address is not valid',
  personBadEmailBody: 'Open the person from the «People» list.',
  personOpen: 'Open the card: {name}',
  personWorkoutPick: 'Which workout to give',
  personWorkoutGiven: 'Workout given',
  personCloseTitle: 'Close access?',
  personCloseBody:
    'The subscription ends now rather than at the end of the period. Courses bought separately stay.',
  personClosed: 'Access closed',
  personRemoveTitle: 'Remove from the club?',
  personRemoveBody: 'They disappear from the solo and duo boards.',
  personRemoveBodyAccess:
    'They disappear from the solo and duo boards. Their club access remains, so they come back the next time they open the tab — to remove them for good, close access first.',
  personRemovedToast: 'Removed from the club',
  // Analytics (0025).
  ...
  // --- Admin: «Today» + payments (0044) ---------------------------------------
  adminTodayTitle: 'Today',
  adminTodayHint: 'the last 24 hours',
  adminTodaySignups: 'New sign-ups',
  adminTodayPayments: 'Payments',
  adminTodayClubJoins: 'Joined the club',
  adminTodayProofs: 'Proofs to review',
  adminTodayUnclaimed: 'Unmatched payments',
  adminTodaySupportUnanswered: 'Unanswered messages',
  adminTodaySupportRecent: 'Messages in the last day',
  adminTodayBookings: 'Sessions today',
  adminTodayError: 'Could not load today',
  adminTodayDuo: 'duo',
  adminTodayDay: 'day {n}',
  adminTabPayments: 'Payments',
  adminPayFilterUnclaimed: 'Unmatched',
  adminPayFilterSessions: 'Sessions',
  adminPayCountOne: '{n} payment',
  adminPayCountFew: '{n} payments',
  adminPayCountMany: '{n} payments',
  adminPayEmptyUnclaimed: 'Every payment is matched',
  adminPayEmptyUnclaimedBody:
    'If money arrives and access does not open, the payment shows up here — and in the Telegram channel.',
  adminPayEmpty: 'No payments',
  adminPayEmptyBody: 'Nothing has come in under this filter yet.',
  adminPayErrorTitle: 'Could not load payments',
  adminPayIntentMonthly: 'Monthly subscription',
  adminPayIntentAnnual: 'Annual subscription',
  adminPayIntentCourse: 'Course',
  adminPayIntentSession: 'Coach session',
  adminPayStateUnclaimed: 'Unmatched',
  adminPayStateApplied: 'Access open',
  adminPayStateBound: 'Matched by hand',
  adminPayStateDismissed: 'Handled',
  adminPayStateSession: 'Paid',
  adminPayCheckoutEmail: 'Checkout email: {email}',
  adminPayNoAccount: 'no account with this address',
  adminPayBoundTo: 'Matched to {email}',
  adminPayClaimedBy: 'Account: {email}',
  adminPayOrder: 'order {ref}',
  adminPayBind: 'Match to a person',
  adminPayDismiss: 'Mark as handled',
  adminPayMore: 'Show more',
  adminPayShowAll: 'Show all payments',
  adminPayOneTitle: 'Payment from the link',
  adminPayBindTitle: 'Match a payment',
  adminPayBindLead: 'Who gets access for this payment. The amount and the till stay as they are.',
  adminPayBindPerson: 'Who',
  adminPayBindCourse: 'Which course to open',
  adminPayBindCourseByOrder: 'From their order',
  adminPayBindCourseHint:
    'If the person placed an order, the course comes from it. If not, pick the course.',
  adminPayBindNext: 'Next',
  adminPayBindConfirmTitle: 'Open access for {email}?',
  adminPayBindConfirmBody:
    '{what} · {amount}. Access opens right away and the payment is marked matched.',
  adminPayBindConfirm: 'Open access',
  adminPayBoundSub: 'Subscription opened',
  adminPayBoundCourse: 'Course opened',
  adminPayDismissTitle: 'Mark the payment as handled?',
  adminPayDismissBody:
    'No access opens. The payment leaves «Unmatched» — you can still match it later under «All».',
  ...
  adminSubRefund: 'Refund',
  adminSubConfirmCloseTitle: 'End access now?',
  adminSubConfirmCloseBody:
    'Club access ends right now and nothing renews. This does not return any money.',
  adminSubConfirmRefundTitle: 'Refund the subscription?',
  adminSubConfirmRefundBody:
    'Access ends now and the subscription is marked refunded. Return the money yourself in the till — Prodamus or lava.top.',
  adminSubClosed: 'Access ended',
  adminSubRefunded: 'Subscription marked refunded',
  adminSubRefundReminder: 'Return the money by hand in the till: {till}.',
  adminStatsGhostAction: 'Open unmatched payments',
  ...
  // --- Admin «Обращения» and «Записи» (0045) ---
  inboxNav: 'Messages',
  inboxTitle: 'Messages',
  inboxTabNew: 'New',
  inboxTabAnswered: 'Answered',
  inboxTabAll: 'All',
  inboxEmptyNew: 'No new messages',
  inboxEmptyNewBody:
    'When someone writes to the bot or taps «Message the coach» in the app, it shows up here.',
  inboxEmpty: 'Nothing here yet',
  inboxLoadError: 'Could not load the messages.',
  inboxChannelBot: 'Bot',
  inboxChannelApp: 'App',
  inboxNoName: 'No name',
  inboxAttachment: 'Caption under an attachment',
  inboxContext: 'Written from: {context}',
  inboxStatusAnswered: 'Answered',
  inboxStatusClosed: 'Closed',
  inboxReply: 'Reply',
  inboxMarkAnswered: 'Mark as answered',
  inboxReopen: 'Back to new',
  inboxClose: 'Close',
  inboxOpenChat: 'Open chat',
  inboxWriteEmail: 'Email',
  inboxAnswered: 'Answered {date}',
  inboxYourReply: 'Reply',
  inboxDeliveryPending: 'In the queue — goes out within 10 minutes',
  inboxDeliverySent: 'Delivered',
  inboxDeliverySkipped: 'Not delivered: the bot is blocked, or Telegram was never linked',
  inboxDeliveryFailed: 'Could not be sent',
  inboxReplyTitle: 'Reply',
  inboxReplyLeadBot:
    'The reply comes from the bot, in their chat with it, signed «Coach’s reply:». It goes out within 10 minutes.',
  inboxReplyLeadWait:
    'This person has no Telegram linked. The reply waits until they open the app from Telegram (up to a week) — an email is more reliable.',
  inboxReplyPlaceholder: 'Write the reply…',
  inboxReplySend: 'Send',
  inboxReplySent: 'Reply sent',
  inboxReplySentHint: 'It reaches their chat within 10 minutes.',
  inboxReplyWaiting: 'Reply saved',
  inboxReplyWaitingHint: 'It goes out once they open the app from Telegram.',
  inboxReplyDemo: 'In the demo the reply goes nowhere.',
  inboxReplyError: 'Could not send the reply.',
  inboxReplyErrorRate: 'Too many replies this hour — try again later.',
  inboxReplyErrorAddress: 'There is nowhere to reply: no Telegram and no email.',
  inboxStatusError: 'Could not change the status.',
  inboxMarkedAnswered: 'Marked as answered',
  inboxReopened: 'Back in new',
  inboxClosed: 'Closed',
  inboxConfirmCloseTitle: 'Close without a reply?',
  inboxConfirmCloseBody: 'The message leaves «New». You can bring it back from «Answered».',
  inboxMore: 'Show more',
  bookingsNav: 'Bookings',
  bookingsTitle: 'Bookings',
  bookingsTabUpcoming: 'Upcoming',
  bookingsTabPast: 'Past',
  bookingsTabCancelled: 'Cancelled',
  bookingsEmptyUpcoming: 'No upcoming sessions',
  bookingsEmpty: 'Nothing here',
  bookingsEmptyBody:
    'Sessions come from the coach’s Google Calendar. Tap «Sync now» to read it right away.',
  bookingsLoadError: 'Could not load the bookings.',
  bookingsMinutes: '{n} min',
  bookingsMsk: 'Moscow time',
  bookingsStatusActive: 'Booked',
  bookingsStatusCancelled: 'Cancelled',
  bookingsSourceGoogle: 'Google Calendar',
