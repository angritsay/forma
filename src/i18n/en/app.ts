...
export const app = {
  ...
  homeDeckLabel: 'Your courses and marathons',
  homeDeckCourse: 'Course',
  homeDeckMarathon: 'Marathon',
  homeDeckMarathonBody: 'Today’s task is waiting inside',
  ...
  marathonProofSend: 'Send',
  marathonProofTarget: 'Target: {n} {unit}',
  ...
  mAdminDueDefault: "The marathon's",
  ...
  mAdminPeopleEmptyBody:
    'Add people by email — the marathon appears for them when they sign in with that address.',
