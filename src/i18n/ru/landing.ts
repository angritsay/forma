...
export const landing = {
  ...
  homeDescription:
    'Пять курсов кроссфита для дома — с оборудованием и без. Пожизненный доступ, нагрузка подстраивается под твой уровень, тренировки на русском.',

  // Главная: hero
  heroTitle: 'Кроссфит дома, который подстраивается под тебя',
  heroSubtitle:
    'Курсы для дома — с оборудованием и без. Пожизненный доступ, тренировки на русском, нагрузка растёт вместе с тобой.',
