...
export const app = {
  ...
  onbBasicsLead:
    'Возраст и пол задают ориентиры для оценки. Вес нужен, чтобы точнее считать калории.',
  onbAgeLabel: 'Возраст',
  onbAge1824: '18–24',
  onbAge2534: '25–34',
  onbAge3544: '35–44',
  ...
  onbTestSkipped: 'не измерено',
  onbAssessOfferTitle: 'Хочешь адаптировать тренировки под себя?',
  onbAssessOfferLead:
    'Нужно будет сказать, сколько раз ты выполнишь {n} упражнений за {min} минут. Без максимумов — в спокойном темпе.',
  onbAssessNow: 'Сейчас',
  ...
  onbAssessInstructionHold:
    'Держи, пока спина остаётся ровной, и нажми «Стоп», когда она начинает проваливаться. Не до предела — время запишется само.',
  onbAssessStop: 'Стоп',
  onbAssessHoldLabel: 'Сколько секунд получилось',
  onbAssessOnKnees: 'С колен',
  onbAssessCountLabel: 'Сколько раз получилось',
  onbAssessDoneTitle: 'Записал',
  onbAssessDoneLead: 'По этим числам подберём стартовую нагрузку.',
  ...
  homeTasksTitle: 'Задание на сегодня',
  homeTaskSteps: 'Напиши, сколько прошёл сегодня',
  homeTaskAssess: 'Адаптировать тренировки под себя',
  homeTaskAssessHint: '5 упражнений, 10 минут — в спокойном темпе',
  ...
  // Статистика
  statsTitle: 'Отчёты',
  statsWeekBoardTitle: 'Таблица недели',
  statsLevelTitle: 'Уровень',
  statsAchievementsLocked: 'Ещё не открыто',
