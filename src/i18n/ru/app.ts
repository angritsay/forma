...
export const app = {
  ...
  adminEditingLanguage: 'Пишем на',
  // Вместо переключателя, пока запись только создаётся: переводить ещё нечего.
  adminRussianFirst: 'Сначала по-русски',
  ...
  // Экран теста как хаб: что спросят, что уже сдано, и что спросят снова.
  assessHow:
    'Выполнять прямо сейчас ничего не нужно. Вспомни или проверь, сколько получается, и впиши числа — по одному на движение.',
  assessUnitReps: 'Повторения',
  assessUnitSeconds: 'Секунды',
  assessTodo: 'Не сдано',
  assessRepeats: 'Тест повторяемый: мы попросим пройти его снова, когда будет с чем сравнить.',
  assessDoneHubTitle: 'Тест пройден',
  assessDoneHubBody:
    'Числа записаны, и по ним подбирается нагрузка. Переписать их нельзя — новый замер будет новым, когда мы о нём попросим.',
  ...
  // Код уезжает в прод мержем, миграции применяются кнопкой — между этими моментами приложение
  // просит у базы то, чего в ней пока нет. Текст называет и причину, и кнопку.
  adminSchemaBehind:
    'База отстала от приложения. Применить миграции: Actions → Supabase apply → migration. {detail}',
  adminAdd: 'Добавить покупку',
  adminAddLead: 'Открывает доступ вручную: перевод, подарок, обращение в поддержку.',
  // «Кто», а не «Почта»: поле теперь ищет по имени и по адресу — «мы обычно знаем их имена». То,
  // что в нём в итоге оказывается, всё равно адрес, но просить его по имени больше не надо.
  adminAddEmail: 'Кто',
  adminPersonPlaceholder: 'Имя или почта',
  adminAddCourse: 'Курс',
  ...
  // The person page (0046): one address, everything known about it.
  personTitle: 'Человек',
  personNoName: 'Без имени',
  personNeverSignedIn: 'Ещё не входил(а) в приложение',
  personSince: 'С нами с {date}',
  personOnboarded: 'Анкета пройдена',
  personNotOnboarded: 'Без анкеты',
  personLevel: 'Уровень {n}',
  personTelegram: 'Телеграм привязан',
  personNoTelegram: 'Без телеграма',
  personSubUntil: 'Подписка до {date}',
  personNoSub: 'Без подписки',
  personGiveCourse: 'Выдать курс',
  personGiveSub: 'Выдать подписку',
  personGiveWorkout: 'Выдать тренировку',
  personCloseAccess: 'Закрыть доступ',
  personRemoveClub: 'Убрать из клуба',
  personAccess: 'Доступ',
  personNoPurchases: 'Курсов нет',
  personSubscription: 'Подписка',
  personClub: 'Клуб',
  personClubAccess: 'Доступ в клуб есть',
  personClubNoAccess: 'Доступа в клуб нет',
  personNotInClub: 'В клуб не заходил(а)',
  personSolo: 'Соло',
  personDuo: 'Дуо',
  personPartner: 'в паре с {name}',
  personPartnerLead: 'в паре с',
  personNoPartner: 'без пары',
  personRemoved: 'убран(а)',
  personProofs: 'Доказательства',
  personNoProofs: 'Пока ничего не присылал(а)',
  personProofDay: 'день {n}',
  personProofCounted: 'Засчитано',
  personProofAccepted: 'Принято',
  personProofWaiting: 'Ждёт проверки',
  personProofRejected: 'Отклонено',
  personAssigned: 'Тренировки от тренера',
  ...
  personActDays: 'дней',
  personActPoints: 'очков',
  personActLast: 'Последняя — {date}',
  personActNever: 'Ещё ни одной тренировки',
  personSessionOpen: 'не закончена',
  personSessionPoints: '{n} очк.',
  personSupport: 'Обращения',
  personNoSupport: 'Не писал(а)',
  personSupportApp: 'Из приложения',
  personSupportTelegram: 'Из телеграма',
  personSupportLimited: 'не принято: лимит',
  personSupportNote: 'Сам текст — в теме «Обращения», здесь только когда и откуда.',
  personPayments: 'Платежи',
  personNoPayments: 'Платежей нет',
  personPayCourse: 'Курс',
  personPayMonthly: 'Подписка на месяц',
  personPayAnnual: 'Подписка на год',
  personPaySession: 'Занятие с тренером',
  personPayApplied: 'привязан',
  personPayClaimed: 'забран {date}',
  personPayPending: 'не привязан',
  personPayVia: 'оплачено с {email}',
  personPayEmails: 'Платит также с: {emails}',
  personLoadError: 'Не удалось загрузить человека',
  personBadEmail: 'В адресе ошибка',
  personBadEmailBody: 'Открой человека из списка «Люди».',
  personOpen: 'Открыть карточку: {name}',
  personWorkoutPick: 'Какую тренировку выдать',
  personWorkoutGiven: 'Тренировка выдана',
  personCloseTitle: 'Закрыть доступ?',
  personCloseBody:
    'Подписка закончится сейчас, а не в конце периода. Курсы, купленные отдельно, останутся.',
  personClosed: 'Доступ закрыт',
  personRemoveTitle: 'Убрать из клуба?',
  personRemoveBody: 'Человек пропадёт из таблиц соло и дуо.',
  personRemoveBodyAccess:
    'Человек пропадёт из таблиц соло и дуо. Доступ в клуб у него остаётся, так что при следующем открытии вкладки он вернётся сам — чтобы убрать насовсем, сначала закрой доступ.',
  personRemovedToast: 'Убран(а) из клуба',
  ...
  adminStatsGhostBody:
    'Оплата есть, аккаунта нет. Обычно это опечатка в адресе или письмо, которое не дошло.',
  adminStatsFunnel: 'Воронка',
  adminStatsFunnelNote: 'По неделе первого входа. Текущая неделя показана, но в итог не входит.',
  adminStatsOfPrev: 'от предыдущего шага',
  adminStatsStepSignedUp: 'Вошли',
  adminStatsStepOnboarded: 'Прошли анкету',
  adminStatsStepTrained: 'Попробовали тренировку',
  adminStatsStepRepeated: 'Вернулись во второй раз',
  adminStatsStepPaid: 'Оплатили',
  adminStatsWeeks: 'По неделям',
  adminStatsWeekRunning: 'идёт',
  adminStatsColWeek: 'Неделя',
  adminStatsPeopleSection: 'Люди',
  adminStatsSearch: 'Имя или почта',
  ...
  adminStatsNoClosedWeeks:
    'Первая закрытая неделя ещё не набралась — доли появятся, когда текущая закончится.',
  adminStatsColSignedUp: 'Вход',
  adminStatsColOnboarded: 'Анкета',
  adminStatsColTrained: 'Трен.',
  adminStatsColRepeated: 'Втор.',
  adminStatsColPaid: 'Опл.',
  adminStatsCoursesBadge: 'курсов: {n}',
  adminStatsError: 'Не удалось загрузить аналитику',
  ...
  builderEmailPlaceholder: 'Имя или почта',
  ...
  // --- Admin: «Сегодня» + платежи (0044) ---------------------------------------
  adminTodayTitle: 'Сегодня',
  adminTodayHint: 'за последние сутки',
  adminTodaySignups: 'Новые регистрации',
  adminTodayPayments: 'Оплаты',
  adminTodayClubJoins: 'Вступили в клуб',
  adminTodayProofs: 'Отчёты ждут проверки',
  adminTodayUnclaimed: 'Непривязанные платежи',
  adminTodaySupportUnanswered: 'Обращения без ответа',
  adminTodaySupportRecent: 'Обращения за сутки',
  adminTodayBookings: 'Занятия сегодня',
  adminTodayError: 'Не удалось загрузить сводку',
  adminTodayDuo: 'дуо',
  adminTodayDay: 'день {n}',
  adminTabPayments: 'Платежи',
  adminPayFilterUnclaimed: 'Непривязанные',
  adminPayFilterSessions: 'Занятия',
  adminPayCountOne: '{n} платёж',
  adminPayCountFew: '{n} платежа',
  adminPayCountMany: '{n} платежей',
  adminPayEmptyUnclaimed: 'Все платежи привязаны',
  adminPayEmptyUnclaimedBody:
    'Если деньги придут, а доступ не откроется, платёж появится здесь — и в канале в Telegram.',
  adminPayEmpty: 'Платежей нет',
  adminPayEmptyBody: 'Под этот фильтр пока ничего не пришло.',
  adminPayErrorTitle: 'Не удалось загрузить платежи',
  adminPayIntentMonthly: 'Подписка на месяц',
  adminPayIntentAnnual: 'Подписка на год',
  adminPayIntentCourse: 'Курс',
  adminPayIntentSession: 'Занятие с тренером',
  adminPayStateUnclaimed: 'Не привязан',
  adminPayStateApplied: 'Доступ открыт',
  adminPayStateBound: 'Привязан вручную',
  adminPayStateDismissed: 'Разобран',
  adminPayStateSession: 'Оплачено',
  adminPayCheckoutEmail: 'Почта в кассе: {email}',
  adminPayNoAccount: 'аккаунта с этой почтой нет',
  adminPayBoundTo: 'Привязан к {email}',
  adminPayClaimedBy: 'Аккаунт: {email}',
  adminPayOrder: 'заказ {ref}',
  adminPayBind: 'Привязать к человеку',
  adminPayDismiss: 'Отметить как разобранный',
  adminPayMore: 'Показать ещё',
  adminPayShowAll: 'Показать все платежи',
  adminPayOneTitle: 'Платёж по ссылке',
  adminPayBindTitle: 'Привязать платёж',
  adminPayBindLead: 'Кому открыть доступ за этот платёж. Сумма и касса останутся как есть.',
  adminPayBindPerson: 'Кому',
  adminPayBindCourse: 'Какой курс открыть',
  adminPayBindCourseByOrder: 'По заказу человека',
  adminPayBindCourseHint:
    'Если человек оформлял заказ, курс возьмётся из него. Если нет — выбери курс.',
  adminPayBindNext: 'Дальше',
  adminPayBindConfirmTitle: 'Открыть доступ {email}?',
  adminPayBindConfirmBody: '{what} · {amount}. Доступ откроется сразу, платёж станет привязанным.',
  adminPayBindConfirm: 'Открыть доступ',
  adminPayBoundSub: 'Подписка открыта',
  adminPayBoundCourse: 'Курс открыт',
  adminPayDismissTitle: 'Отметить платёж как разобранный?',
  adminPayDismissBody:
    'Доступ не откроется. Платёж уйдёт из «Непривязанных» — привязать его можно будет позже во вкладке «Все».',
  adminPayDismissed: 'Платёж отмечен разобранным',
  adminPayErrNoOrder: 'У человека нет ожидающего заказа — выбери курс.',
  adminPayErrApplied: 'Этот платёж уже привязан.',
  adminPayErrSession: 'Занятие ничего не открывает — привязывать нечего.',
  adminPayErrCourse: 'Такого курса нет в каталоге.',
  adminSubStatusRefunded: 'Возврат',
  adminSubCloseNow: 'Закрыть доступ сейчас',
  adminSubRefund: 'Возврат подписки',
  adminSubConfirmCloseTitle: 'Закрыть доступ сейчас?',
  adminSubConfirmCloseBody:
    'Доступ к клубу закончится прямо сейчас, продлений не будет. Деньги это не возвращает.',
  adminSubConfirmRefundTitle: 'Оформить возврат подписки?',
  adminSubConfirmRefundBody:
    'Доступ закроется сейчас, подписка будет отмечена как возвращённая. Сами деньги верни вручную в кассе — Prodamus или lava.top.',
  adminSubClosed: 'Доступ закрыт',
  adminSubRefunded: 'Подписка отмечена как возвращённая',
  adminSubRefundReminder: 'Деньги верни вручную в кассе: {till}.',
  adminStatsGhostAction: 'Открыть непривязанные платежи',
  ...
  exShortNameEn: 'Короткое название (EN)',
  ...
  // --- Админка: «Обращения» и «Записи» (0045) ---
  inboxNav: 'Обращения',
  inboxTitle: 'Обращения',
  inboxTabNew: 'Новые',
  inboxTabAnswered: 'Отвеченные',
  inboxTabAll: 'Все',
  inboxEmptyNew: 'Новых обращений нет',
  inboxEmptyNewBody:
    'Когда человек напишет боту или нажмёт «Написать тренеру» в приложении, обращение появится здесь.',
  inboxEmpty: 'Здесь пока пусто',
  inboxLoadError: 'Не удалось загрузить обращения.',
  inboxChannelBot: 'Бот',
  inboxChannelApp: 'Приложение',
  inboxNoName: 'Без имени',
  inboxAttachment: 'Подпись к вложению',
  inboxContext: 'Откуда: {context}',
  inboxStatusAnswered: 'Отвечено',
  inboxStatusClosed: 'Закрыто',
  inboxReply: 'Ответить',
  inboxMarkAnswered: 'Отметить отвеченным',
  inboxReopen: 'Вернуть в новые',
  inboxClose: 'Закрыть',
  inboxOpenChat: 'Открыть чат',
  inboxWriteEmail: 'Написать на почту',
  inboxAnswered: 'Отвечено {date}',
  inboxYourReply: 'Ответ',
  inboxDeliveryPending: 'В очереди — уйдёт в течение 10 минут',
  inboxDeliverySent: 'Доставлен',
  inboxDeliverySkipped: 'Не дошёл: бот заблокирован или Телеграм так и не привязали',
  inboxDeliveryFailed: 'Не удалось отправить',
  inboxReplyTitle: 'Ответ',
  inboxReplyLeadBot:
    'Ответ придёт от бота в тот же чат с подписью «Ответ тренера:». Уходит в течение 10 минут.',
  inboxReplyLeadWait:
    'У человека не привязан Телеграм. Ответ дождётся, когда он откроет приложение из Телеграма (до недели), — надёжнее написать на почту.',
  inboxReplyPlaceholder: 'Напиши ответ…',
  inboxReplySend: 'Отправить',
  inboxReplySent: 'Ответ отправлен',
  inboxReplySentHint: 'В чат он придёт в течение 10 минут.',
  inboxReplyWaiting: 'Ответ сохранён',
  inboxReplyWaitingHint: 'Уйдёт, когда человек откроет приложение из Телеграма.',
  inboxReplyDemo: 'В демо ответ никуда не уходит.',
  inboxReplyError: 'Не удалось отправить ответ.',
  inboxReplyErrorRate: 'Слишком много ответов за час — попробуй позже.',
  inboxReplyErrorAddress: 'Ответить некуда: нет ни Телеграма, ни почты.',
  inboxStatusError: 'Не удалось поменять статус.',
  inboxMarkedAnswered: 'Отмечено отвеченным',
  inboxReopened: 'Снова в новых',
  inboxClosed: 'Закрыто',
  inboxConfirmCloseTitle: 'Закрыть без ответа?',
  inboxConfirmCloseBody: 'Обращение уйдёт из «Новых». Вернуть его можно на вкладке «Отвеченные».',
  inboxMore: 'Показать ещё',
  bookingsNav: 'Записи',
  bookingsTitle: 'Записи',
  bookingsTabUpcoming: 'Предстоящие',
  bookingsTabPast: 'Прошедшие',
  bookingsTabCancelled: 'Отменённые',
  ...
  bookingsMsk: 'МСК',
  bookingsStatusActive: 'Записан',
  bookingsStatusCancelled: 'Отменена',
  bookingsSourceGoogle: 'Google Календарь',
