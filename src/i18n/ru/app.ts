...
export const app = {
  ...
  // --- Управление клубом (0047): копирование недель, пары, живой клуб, «Не просмотрено» ---
  clubRoundsTitle: 'Круги',
  clubCopyWeek: 'Скопировать неделю',
  clubCopyTitle: 'Скопировать задания',
  clubCopyFrom: 'Откуда: {week}',
  clubCopyWeekN: 'неделя {n}',
  clubCopyWeekDates: 'неделя {n} · {from} – {to}',
  clubCopyModeWeek: 'В другую неделю',
  clubCopyModeToDuo: 'В дуо-клуб',
  clubCopyModeToSolo: 'В соло-клуб',
  clubCopyTo: 'Куда',
  clubCopyNoWeeks: 'Дальше этой недели в круге дней нет.',
  clubCopyToClub: 'Куда: «{title}», те же даты — {from} – {to}',
  clubCopyNoDates: 'В другом клубе этих дат нет.',
  clubCopyOverwrite: 'Заменить, где уже есть задания',
  clubCopyOverwriteHint: 'Дни, где уже прислали пруфы, не заменяются никогда',
  clubCopyCounting: 'Считаю…',
  clubCopyEmpty: 'Копировать нечего: на этой неделе нет заданий.',
  clubCopyWill: 'Скопируется заданий: {tasks}, дней: {days}.',
  clubCopyWillReplace: 'Будет заменено заданий: {n}.',
  clubCopySkipped: 'Пропущено дней: {n} — там уже есть задания.',
  clubCopyLocked: 'Не заменено дней: {n} — там уже прислали пруфы.',
  clubCopyRun: 'Скопировать: {n}',
  clubCopyRunIdle: 'Скопировать',
  clubCopyConfirmTitle: 'Заменить задания?',
  clubCopyConfirmBody:
    'Заданий будет удалено: {n}. На их место встанут скопированные. Отменить это нельзя.',
  clubCopyConfirm: 'Заменить',
  clubCopyDone: 'Скопировано заданий: {n}',
  clubCopyDoneSkipped: 'Пропущено дней: {n}',
  clubErrOverlap: 'Недели пересекаются — выберите другую',
  clubErrOutOfRange: 'Эти дни выходят за границы круга',
  clubErrAlreadyPaired: 'У кого-то из двоих уже есть пара',
  clubErrNotInClub: 'Этого человека нет в дуо-клубе',
  clubErrNoClub: 'Сейчас нет живого дуо-клуба',
  clubErrModeMismatch: 'Режим круга не совпадает — поменяйте «Как играют» в настройках',
  clubErrTeamGone: 'Этой пары уже нет — обновите экран',
  clubPairsTitle: 'Пары: {n}',
  clubPairsUnpaired: 'без пары: {n}',
  clubPairsEmpty: 'Пар пока нет.',
  clubPairsRematch: 'Пересобрать пары сейчас',
  clubPairsRematchTitle: 'Пересобрать пары сейчас?',
  clubPairsRematchBody:
    'Все пары на неделю разойдутся и соберутся заново жеребьёвкой — так же, как в понедельник. Пары по приглашению и те, что вы оставили, не тронем. Участники увидят новых напарников сразу.',
  clubPairsRematchConfirm: 'Пересобрать',
  clubPairsRematched: 'Собрано пар: {n}',
  clubPairAuto: 'на неделю, до понедельника',
  clubPairKept: 'постоянная — жеребьёвка не трогает',
  clubPairSplit: 'Разбить',
  clubPairSplitTitle: 'Разбить пару «{names}»?',
  clubPairSplitBody:
    'Оба останутся в клубе без пары и увидят это сразу. Очки никуда не денутся. Новую пару даст понедельник или «Поставить в пару».',
  clubPairSplitDone: 'Пара разбита',
  clubPairMake: 'Поставить в пару',
  clubPairMakeTitle: 'Пара для: {name}',
  clubPairPartner: 'С кем',
  clubPairKeep: 'Оставить и после понедельника',
  clubPairKeepHint: 'Иначе в понедельник пара уйдёт в общую жеребьёвку',
  clubPairMakeBody: 'Оба сразу увидят, с кем они в паре.',
  clubPairMadeDone: 'Пара собрана',
  clubLiveBadgeSolo: 'Клуб · соло',
  clubLiveBadgeDuo: 'Клуб · дуо',
  clubLiveRowSolo: 'Соло-клуб',
  clubLiveRowDuo: 'Дуо-клуб',
  clubLiveIsHint: 'Этот круг сейчас клуб: в нём все, у кого есть подписка.',
  clubLiveNowIs: 'Сейчас клуб — «{title}».',
  clubLiveNowNone: 'Сейчас клуба этого режима нет.',
  clubLiveMakeSolo: 'Сделать соло-клубом',
  clubLiveMakeDuo: 'Сделать дуо-клубом',
  clubLiveAsk: 'Сделать клубом сейчас?',
  clubLiveAskHint:
    'Клуб — круг, в котором все с подпиской, и он не заканчивается. Недели доски считаются от даты старта — лучше понедельник. Решить можно и потом, в настройках.',
  clubLiveAskNo: 'Нет, пока черновик',
  clubLiveAskYesSolo: 'Да, это новый соло-клуб',
  clubLiveAskYesDuo: 'Да, это новый дуо-клуб',
  clubLiveConfirmTitleSolo: 'Сделать «{title}» соло-клубом?',
  clubLiveConfirmTitleDuo: 'Сделать «{title}» дуо-клубом?',
  clubLiveConfirmBody: 'Участники увидят его сразу, как откроют вкладку «Клуб».',
  clubLiveConfirmBodySwap:
    'Участники увидят его сразу, как откроют вкладку «Клуб». Прежний клуб «{previous}» завершится: его доска и пруфы останутся в админке.',
  clubLiveConfirm: 'Сделать клубом',
  clubLiveDone: 'Теперь это клуб',
  clubQueueTitle: 'Не просмотрено',
  clubQueueLoading: 'Загружаю…',
  clubQueueEmpty: 'Всё просмотрено.',
  clubQueueSolo: 'Соло',
  clubQueueDuo: 'Дуо',
  clubQueueAccept: 'Засчитать',
  clubQueueReject: 'Не засчитать',
  clubQueueAccepted: 'Засчитано',
  clubQueueMore: 'Показать ещё · {n}',
  clubQueueOne: 'Пруф',
  clubQueueNotFound: 'Такого пруфа нет',
  clubQueueStateSeen: 'Уже просмотрено — засчитано.',
  clubQueueStateVoided: 'Уже просмотрено — не засчитано.',
  clubQueueAll: 'Всё просмотрено',
  clubQueueAllTitle: 'Отметить просмотренными: {n}?',
  clubQueueAllBody:
    'Все пруфы в списке останутся засчитанными и уйдут из «Не просмотрено». Отклонить любой из них можно потом в ленте круга.',
  clubQueueAllConfirm: 'Отметить',
  clubQueueAllDone: 'Отмечено: {n}',
