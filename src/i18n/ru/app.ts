...
export const app = {
  ...
  mAdminAudience: 'Кому',
  mAdminAudienceAll: 'Всем',
  mAdminAudienceTeams: 'Только командам',
  mAdminAudienceSolo: 'Только одиночкам',
  ...
  mAdminDueDefault: 'Как у марафона',
  ...
  mAdminPeopleEmptyBody:
    'Добавь участников по почте — они увидят марафон, когда войдут с этим адресом.',
