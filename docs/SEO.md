...
| robots.txt               | `src/pages/robots.txt.ts`                | `Allow: /`, `Disallow: <base>/app/`, `Sitemap:`, `Host:`. Only effective at the origin root — on a GitHub Pages _project_ site (base path) crawlers do not read it; use a custom domain or accept it.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
